          ...
          {photos.map((photo, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"
                ...
                <p className="text-sm" style={{ fontFamily: "'Cormorant Garamond', serif", color: "#f5e6d0", fontStyle: "italic" }}>
                  {photo.caption}
                </p>
              </div>
              <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: "rgba(201,169,110,0.3)" }}>
                  <Heart size={14} style={{ color: "#c9a96e" }} />
                </div>
              </div>
            </motion.div>
          ))}
        ...
        {lightbox !== null && (
          ...
          >
            ...
            >
              ...
              />
              <p className="text-center mt-4 text-sm" style={{ fontFamily: "'Cormorant Garamond', serif", color: "#d4c0a5", fontStyle: "italic" }}>
